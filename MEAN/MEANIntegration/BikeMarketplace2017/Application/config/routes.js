...
module.exports = function(app){
    app.post('/addinguser', user.createuser); 
    app.post('/findinguser', user.finduser);
    app.post('/creatingbike', bike.createbike);
    app.post('/usersbikeslist', bike.showbikes);
    app.get('/allbikes', bike.allbikes)
    app.post('/searchbike', bike.searchbike)
