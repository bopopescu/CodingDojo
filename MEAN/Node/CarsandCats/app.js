...
var server = http.createServer(function (request, response){
    ...
    if(request.url === '/') {
        ...
        fs.readFile('./views/cars.html', 'utf8', function (errors, contents){
         ...
         fs.readFile('./views/formcars.html', 'utf8', function (errors, contents){
             response.writeHead(200, {'Content-type': 'text/html'});
             response.write(contents); 
             response.end();
         });
    ...
    else if(request.url === '/images/mazda.jpeg'){
    // notice we won't include the utf8 encoding
    fs.readFile('./images/mazda.jpeg', function(errors, contents){
        response.writeHead(200, {'Content-type': 'image/jpg'});
        response.write(contents);
        response.end();
    })
  }
  else if(request.url === '/images/subaru.jpeg'){
    // notice we won't include the utf8 encoding
    fs.readFile('./images/subaru.jpeg', function(errors, contents){
        response.writeHead(200, {'Content-type': 'image/jpg'});
        response.write(contents);
        response.end();
    })
